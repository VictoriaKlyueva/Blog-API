...
namespace BackendLaboratory.Migrations
{
    ...
    [Migration("20241202175127_FinallyFixedTags")]
    partial class FinallyFixedTags
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BackendLaboratory.Data.Entities.Tag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7dd1e51a-606f-4dea-e6e3-08dbea521a91"),
                            CreateTime = new DateTime(2024, 12, 2, 17, 51, 27, 154, DateTimeKind.Utc).AddTicks(9953),
                            Name = "задор"
                        },
                        new
                        {
